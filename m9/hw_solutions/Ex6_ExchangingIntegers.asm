; Chapter 8, Exercise 6: Exchanging Integers

Comment !
Create an array of randomly ordered integers. Using the
Swap procedure from Section 8.4.6 as a tool, write a loop that
